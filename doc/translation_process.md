...
Multiple language support is critical in assisting Fujicoin’s global adoption, and growth. One of Fujicoin’s greatest strengths is cross-boarder money transfers, any help making that easier is greatly appreciated.
...
To create a new language template, you will need to edit the languages manifest file `src/qt/fujicoin.qrc` and add a new entry. Below is an example of the english language entry.
