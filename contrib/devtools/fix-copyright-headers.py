...
// Copyright (c) 2009-2012 The Fujicoin Core developers
...
CMD_REGEX= "perl -pi -e 's/(20\d\d)(?:-20\d\d)? The Fujicoin/$1-%s The Fujicoin/' %s"
REGEX_CURRENT= re.compile("%s The Fujicoin" % year)
