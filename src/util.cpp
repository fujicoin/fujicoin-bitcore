...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", FUJICOIN_CONF_FILENAME));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", FUJICOIN_PID_FILENAME));
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    if (strCopyrightHolders.find("Fujicoin Core developers") == strCopyrightHolders.npos) {
