...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CFujicoinAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CFujicoinAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CFujicoinAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CFujicoinAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CFujicoinAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CFujicoinAddress(arr[0].get_str()).Get() == demoAddress.Get());
